...
export class BookModule {
  ...
  title(): string {
    const titles = [
      ...
      'Brave New World', 'The Divine Comedy', 'Crime and Punishment', 'The Brothers Karamazov',
      'One Hundred Years of Solitude', 'The Sound and the Fury', 'Invisible Man', 'Beloved',
      'The Grapes of Wrath', 'Catch-22', 'Slaughterhouse-Five', 'Fahrenheit 451',
      'The Handmaid\'s Tale', 'The Road', 'Life of Pi', 'The Kite Runner', 'The Book Thief',
    ]
  ...
  author(): string {
    const authors = [
      ...
      'Stephen King', 'Agatha Christie', 'William Shakespeare', 'Edgar Allan Poe', 'Harper Lee',
      'Maya Angelou', 'Toni Morrison', 'Gabriel García Márquez', 'Franz Kafka', 'James Joyce',
      'Virginia Woolf', 'Oscar Wilde', 'Emily Dickinson', 'Walt Whitman', 'Robert Frost',
      'Sylvia Plath', 'Kurt Vonnegut', 'Margaret Atwood', 'Haruki Murakami', 'Chimamanda Ngozi Adichie',
    ]
  ...
  publisher(): string {
    const publishers = [
      ...
      'Wiley', 'Springer', 'McGraw-Hill', 'Bloomsbury', 'Vintage', 'Doubleday', 'Knopf',
    ]
  ...
  genre(): string {
    const genres = [
      ...
      'Drama', 'Comedy', 'Adventure', 'Young Adult', 'Children\'s', 'Crime', 'Western',
      'Dystopian', 'Paranormal', 'Contemporary', 'Classic', 'Literary Fiction',
    ]
  ...
  series(): string {
    const series = [
      ...
      'Divergent', 'The Mortal Instruments', 'Sherlock Holmes', 'Discworld', 'Dune',
      'Foundation', 'The Wheel of Time', 'The Witcher', 'Millennium', 'Jack Reacher',
    ]
  ...
  format(): string {
    const formats = [
      ...
      'Kindle', 'PDF', 'EPUB', 'Board Book', 'Leather Bound', 'Library Binding',
    ]
