...
export const en_CA: Partial<LocaleDefinition> = {
  ...
  address: {
    city: [
      ...
      'Hamilton', 'Kitchener', 'London', 'Victoria', 'Halifax', 'Oshawa',
      'Windsor', 'Saskatoon', 'Regina', 'St. John\'s', 'Kelowna', 'Barrie',
      'Guelph', 'Kingston', 'Thunder Bay', 'Moncton', 'Fredericton',
    ],
    state: [
  ...
  food: {
    dish: [
      'Poutine', 'Montreal Smoked Meat', 'Tourtière', 'Butter Tarts', 'Nanaimo Bars',
      'Bannock', 'Peameal Bacon', 'Caesar Cocktail', 'Kraft Dinner', 'Tim Bits',
      'Beaver Tails', 'Split Pea Soup', 'Maple Syrup', 'Montreal Bagels',
    ],
    cuisine: [
      'Canadian', 'French Canadian', 'Indigenous', 'Maritime', 'Prairie',
      'West Coast', 'Arctic', 'Fusion',
    ],
  },
