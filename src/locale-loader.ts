...
export class LocaleLoader {
  ...
  static readonly AVAILABLE_LOCALES = [
    'en', 'es', 'fr', 'de', 'it', 'pt', 'ja', 'tl', 'zh',
    'nl', 'ko', 'no', 'sv', 'da', 'uk', 'hi', 'fi', 'tr', 'pl', 'cs',
  ] as const
  ...
  private static async loadLocaleModule(locale: string): Promise<LocaleDefinition> {
    try {
      ...
      let module: { [key: string]: LocaleDefinition }
      ...
      switch (locale) {
        ...
        case 'de':
          ...
          return module.de
        case 'it':
          module = await import('./locales/it')
          return module.it
        case 'pt':
        ...
        case 'ja':
          ...
          return module.ja
        case 'tl':
          module = await import('./locales/tl')
          return module.tl
        case 'zh':
          module = await import('./locales/zh')
          return module.zh
        case 'nl':
          module = await import('./locales/nl')
          return module.nl
        case 'ko':
          module = await import('./locales/ko')
          return module.ko
        case 'no':
          module = await import('./locales/no')
          return module.no
        case 'sv':
          module = await import('./locales/sv')
          return module.sv
        case 'da':
          module = await import('./locales/da')
          return module.da
        case 'uk':
          module = await import('./locales/uk')
          return module.uk
        case 'hi':
          module = await import('./locales/hi')
          return module.hi
        case 'fi':
          module = await import('./locales/fi')
          return module.fi
        case 'tr':
        ...
        case 'pl':
          ...
          return module.pl
        case 'cs':
          module = await import('./locales/cs')
          return module.cs
        default:
