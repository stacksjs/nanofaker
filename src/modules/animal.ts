...
export class AnimalModule {
  ...
  dog(): string {
    const breeds = [
      ...
      'English Springer Spaniel', 'Brittany', 'Pug', 'Cocker Spaniel', 'Border Collie',
    ]
  ...
  cat(): string {
    const breeds = [
      ...
      'Birman', 'Oriental Shorthair', 'Norwegian Forest Cat', 'Cornish Rex', 'Himalayan',
      'Exotic Shorthair', 'Burmese', 'Turkish Angora', 'Somali', 'Manx', 'Tonkinese',
    ]
    return this.random.arrayElement(breeds)
  }
  ...
  bird(): string {
    const birds = [
      ...
      'Hummingbird', 'Woodpecker', 'Pelican', 'Swan', 'Duck', 'Goose', 'Flamingo', 'Penguin',
      'Ostrich', 'Emu', 'Peacock', 'Turkey', 'Chicken', 'Rooster',
    ]
  ...
  fish(): string {
    const fish = [
      ...
      'Swordfish', 'Shark', 'Ray', 'Barracuda', 'Catfish', 'Bass', 'Pike', 'Trout', 'Carp',
    ]
  ...
  bear(): string {
    const bears = [
      'Grizzly Bear', 'Black Bear', 'Polar Bear', 'Brown Bear', 'Panda Bear', 'Sun Bear',
      'Sloth Bear', 'Spectacled Bear', 'Asian Black Bear', 'Kodiak Bear',
    ]
  ...
  cetacean(): string {
    const cetaceans = [
      'Blue Whale', 'Humpback Whale', 'Orca', 'Dolphin', 'Porpoise', 'Beluga Whale',
      'Sperm Whale', 'Gray Whale', 'Narwhal', 'Bottlenose Dolphin', 'Pilot Whale',
    ]
  ...
  horse(): string {
    const breeds = [
      ...
      'Percheron', 'Belgian', 'Shire', 'Haflinger', 'Icelandic', 'Shetland Pony',
    ]
    return this.random.arrayElement(breeds)
  }
  ...
  insect(): string {
    const insects = [
      ...
      'Praying Mantis', 'Cicada', 'Caterpillar', 'Walking Stick',
    ]
  ...
  snake(): string {
    const snakes = [
      'Python', 'Boa Constrictor', 'Rattlesnake', 'Cobra', 'Viper', 'Anaconda', 'Garter Snake',
      'Corn Snake', 'King Snake', 'Milk Snake', 'Black Mamba', 'Copperhead', 'Cottonmouth',
    ]
